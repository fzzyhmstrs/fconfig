...
Either [CurseForge 🔗](https://www.curseforge.com/minecraft/mc-mods/fzzy-config/files), [Modrinth 🔗](https://modrinth.com/mod/fzzy-config/versions), or the [Maven itself 🔗](https://maven.fzzyhmstrs.me/me/fzzyhmstrs/fzzy_config/) can be used to see the current version listings.

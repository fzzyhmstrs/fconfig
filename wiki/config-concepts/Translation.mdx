...
## Concept
Translation in Fzzy Config is driven by the [Translatable](https://fzzyhmstrs.github.io/fconfig/-fzzy%20-config/me.fzzyhmstrs.fzzy_config.util/-translatable/index.html) interface or the [@Translation](https://github.com/fzzyhmstrs/fconfig/wiki/Annotations#translation-) annotation.
...
* Prefixes often won't be rendered in popups or other situations outside of the normal config GUI.
...
### @Translation
If you want to override the default translation key system, or provide a translation and description for something without implementing Translatable, you can use the `@Translation` annotation. This annotation provides a prefix that the annotated field name is appended to. See the annotations article for details.
...
**NOTE: this translates the enum constants themselves. The field holding the enum gets its own translation following the rules above**
...
// this enum will have a translation key like "my_mod.test_enum.ALPHA" etc.

...
### Conditions
`ValidatedBoolean` can be used directly as an input condition into a `ValidatedCondition`. See [Conditional Settings](../Validation#conditional-settings-) to learn more.
...
### Translation
Enums can implement a special interface `EnumTranslatable` that allows for translation of enum constants and custom tooltips per constant. See [Translation](https://github.com/fzzyhmstrs/fconfig/wiki/Translation#enumtranslatable) for details.

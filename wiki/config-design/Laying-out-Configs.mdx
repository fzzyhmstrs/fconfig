...
### Groups
Added as of Fzzy Config 0.6.0. Groups are inline organization elements that don't _structurally_ change the config in-code. They are used for visual organization of information in a config GUI, and as an [anchor](#3-anchors) for quick navigation.

...
Fzzy Config has a lightweight `PlatformApi`, for performing common platform-specific functions without needing to write your own abstractions or having to rely on a separate API like Architectury.

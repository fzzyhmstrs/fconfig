...
import me.fzzyhmstrs.fzzy_config.validated_field_v2.entry.EntryHandler
...
class ValidatedColor: ValidatedField<ValidatedColor.ColorHolder> {
    ...
    override fun deserializeEntry(toml: TomlElement, fieldName: String): ValidationResult<ColorHolder> {
        return storedValue.deserializeEntry(toml, fieldName)
    }

    override fun serializeEntry(input: ColorHolder): TomlElement {
        return storedValue.serializeEntry(input)
    }

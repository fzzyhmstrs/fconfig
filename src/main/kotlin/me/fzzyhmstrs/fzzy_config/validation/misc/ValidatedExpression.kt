    ...
    private class ExpressionButtonWidget(private val entry: ValidatedExpression, private val choiceValidator: ChoiceValidator<String>): PressableWidget(0, 0, 110, 20, entry.get().lit()) {
        ...
        private fun openExpressionEditPopup() {
            ...
            val popup = PopupWidget.Builder("fc.validated_field.expression".translate())
                .addElement("ln",    ButtonWidget.builder("ln".lit())    { add("ln()", 3) }    .size(56, 20).tooltip(Tooltip.of("fc.validated_field.expression.ln.tip".translate())).build(), Position.BELOW, Position.ALIGN_LEFT)
                .addElement("min",   ButtonWidget.builder("min".lit())   { add("min(, )", 4) } .size(56, 20).tooltip(Tooltip.of("fc.validated_field.expression.min.tip".translate())).build(), "ln", Position.RIGHT, Position.HORIZONTAL_TO_TOP_EDGE)
                .addElement("max",   ButtonWidget.builder("max".lit())   { add("max(, )", 4) } .size(56, 20).tooltip(Tooltip.of("fc.validated_field.expression.max.tip".translate())).build(), "min", Position.RIGHT, Position.HORIZONTAL_TO_TOP_EDGE)
                .addElement("log",   ButtonWidget.builder("log".lit())   { add("log(, )", 4) } .size(56, 20).tooltip(Tooltip.of("fc.validated_field.expression.log.tip".translate())).build(), "ln", Position.BELOW, Position.ALIGN_LEFT)
                .addElement("log10", ButtonWidget.builder("log10".lit()) { add("log10()", 6) } .size(56, 20).tooltip(Tooltip.of("fc.validated_field.expression.log10.tip".translate())).build(), "log", Position.RIGHT, Position.HORIZONTAL_TO_TOP_EDGE)
                .addElement("log2",  ButtonWidget.builder("log2".lit())  { add("log2()", 5) }  .size(56, 20).tooltip(Tooltip.of("fc.validated_field.expression.log2.tip".translate())).build(), "log10", Position.RIGHT, Position.HORIZONTAL_TO_TOP_EDGE)
                .addElement("sqrt",  ButtonWidget.builder("sqrt".lit())  { add("sqrt()", 5) }  .size(32, 20).tooltip(Tooltip.of("fc.validated_field.expression.sqrt.tip".translate())).build(), "log", Position.BELOW, Position.ALIGN_LEFT)
                .addElement("abs",   ButtonWidget.builder("abs".lit())   { add("abs()", 4) }   .size(32, 20).tooltip(Tooltip.of("fc.validated_field.expression.abs.tip".translate())).build(), "sqrt", Position.RIGHT, Position.HORIZONTAL_TO_TOP_EDGE)
                .addElement("sin",   ButtonWidget.builder("sin".lit())   { add("sin()", 4) }   .size(32, 20).tooltip(Tooltip.of("fc.validated_field.expression.sin.tip".translate())).build(), "abs", Position.RIGHT, Position.HORIZONTAL_TO_TOP_EDGE)
                .addElement("cos",   ButtonWidget.builder("cos".lit())   { add("cos()", 4) }   .size(32, 20).tooltip(Tooltip.of("fc.validated_field.expression.cos.tip".translate())).build(), "sin", Position.RIGHT, Position.HORIZONTAL_TO_TOP_EDGE)
                .addElement("pow",   ButtonWidget.builder("^".lit())     { add(" ^ ", 3) }     .size(32, 20).tooltip(Tooltip.of("fc.validated_field.expression.pow.tip".translate())).build(), "cos", Position.RIGHT, Position.HORIZONTAL_TO_TOP_EDGE)
                .addElement("paren", ButtonWidget.builder("(_)".lit())   { add("()", 1) }      .size(32, 20).tooltip(Tooltip.of("fc.validated_field.expression.paren.tip".translate())).build(), "sqrt", Position.BELOW, Position.ALIGN_LEFT)
                .addElement("incr",  ButtonWidget.builder("incr".lit())  { add("incr(, )", 5) }.size(32, 20).tooltip(Tooltip.of("fc.validated_field.expression.incr.tip".translate())).build(), "paren", Position.RIGHT, Position.HORIZONTAL_TO_TOP_EDGE)
                .addElement("ciel",  ButtonWidget.builder("ciel".lit())  { add("ciel()", 5) }  .size(32, 20).tooltip(Tooltip.of("fc.validated_field.expression.ciel.tip".translate())).build(), "incr", Position.RIGHT, Position.HORIZONTAL_TO_TOP_EDGE)
                .addElement("flr",   ButtonWidget.builder("flr".lit())   { add("floor()", 6) } .size(32, 20).tooltip(Tooltip.of("fc.validated_field.expression.flr.tip".translate())).build(), "ciel", Position.RIGHT, Position.HORIZONTAL_TO_TOP_EDGE)
                .addElement("rnd",   ButtonWidget.builder("rnd".lit())   { add("round()", 6) } .size(32, 20).tooltip(Tooltip.of("fc.validated_field.expression.rnd.tip".translate())).build(), "flr", Position.RIGHT, Position.HORIZONTAL_TO_TOP_EDGE)
                .addElement("plus",  ButtonWidget.builder("+".lit())     { add(" + ", 3) }     .size(32, 20).tooltip(Tooltip.of("fc.validated_field.expression.plus.tip".translate())).build(), "paren", Position.BELOW, Position.ALIGN_LEFT)
                .addElement("minus", ButtonWidget.builder("-".lit())     { add(" - ", 3) }     .size(32, 20).tooltip(Tooltip.of("fc.validated_field.expression.minus.tip".translate())).build(), "plus", Position.RIGHT, Position.HORIZONTAL_TO_TOP_EDGE)
                .addElement("times", ButtonWidget.builder("*".lit())     { add(" * ", 3) }     .size(32, 20).tooltip(Tooltip.of("fc.validated_field.expression.times.tip".translate())).build(), "minus", Position.RIGHT, Position.HORIZONTAL_TO_TOP_EDGE)
                .addElement("div",   ButtonWidget.builder("/".lit())     { add(" / ", 3) }     .size(32, 20).tooltip(Tooltip.of("fc.validated_field.expression.div.tip".translate())).build(), "times", Position.RIGHT, Position.HORIZONTAL_TO_TOP_EDGE)
                .addElement("mod",   ButtonWidget.builder("%".lit())     { add(" % ", 3) }     .size(32, 20).tooltip(Tooltip.of("fc.validated_field.expression.mod.tip".translate())).build(), "div", Position.RIGHT, Position.HORIZONTAL_TO_TOP_EDGE)

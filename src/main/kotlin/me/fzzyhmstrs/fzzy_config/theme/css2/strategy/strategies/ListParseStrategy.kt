...
class ListParseStrategy<A: Any> private constructor(
    ...
    private vararg val endGateBehavior: EndGateBehavior)
    : ParseStrategy<List<A>, ListParseStrategy.StrategyBuilder<A>>
{
    ...
    class StrategyBuilder<A: Any>: ParseStrategy.Builder<List<A>> {
        ...
        override fun build(): ValidationResult<List<A>> {
            ...
            return ValidationResult.predicated(list, errors.isEmpty(), "Errors found constructing list: $errors")
        }
    }
    ...
    companion object {
            ...
            private val separator: Predicate<Token<*>>)
        {
            ...
            fun build(): ListParseStrategy<A> {
                return ListParseStrategy(strategy, startDelimiter, endDelimiter, separator, endGates, provider, *endGateBehaviors.toTypedArray())
            }

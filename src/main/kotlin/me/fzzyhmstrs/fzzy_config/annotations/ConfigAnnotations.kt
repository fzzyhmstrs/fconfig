...
enum class Action(val restartPrompt: Boolean, val sprite: Identifier, val clientPrompt: Text, val clientUpdateMessage: Text, val serverUpdateMessage: Text, val settingTooltip: Text, val sectionTooltip: Text, val configTooltip: Text) {
    ...
    RESTART(
        ...
        "fc.config.restart.update.client".translate().append(" ".lit()).append("fc.config.restart.update.client.prompt".translate().styled { s -> s.withClickEvent(ClickEvent(ClickEvent.Action.RUN_COMMAND, "/fzzy_config_restart")) }),
    ...
    RELOG(
        ...
        "fc.config.relog.update.client".translate().append(" ".lit()).append("fc.config.relog.update.client.prompt".translate().styled { s -> s.withClickEvent(ClickEvent(ClickEvent.Action.RUN_COMMAND, "/fzzy_config_leave_game")) }),
    ...
    RELOAD_BOTH(
        ...
        "fc.config.reload_both.update.client".translate().append(" ".lit()).append("fc.config.reload_data.update.prompt".translate().styled { s -> s.withClickEvent(ClickEvent(ClickEvent.Action.RUN_COMMAND, "/reload")) }).append(" ".lit()).append("fc.config.reload_resources.update.client.prompt".translate().styled { s -> s.withClickEvent(ClickEvent(ClickEvent.Action.RUN_COMMAND, "/fzzy_config_reload_resources")) }),
        "fc.config.reload_both.update.server".translate().append(" ".lit()).append("fc.config.reload_data.update.prompt".translate().styled { s -> s.withClickEvent(ClickEvent(ClickEvent.Action.RUN_COMMAND, "/reload")) }),
    ...
    RELOAD_DATA(
        ...
        "fc.config.reload_data.update.client".translate().append(" ".lit()).append("fc.config.reload_data.update.prompt".translate().styled { s -> s.withClickEvent(ClickEvent(ClickEvent.Action.RUN_COMMAND, "/reload")) }),
        "fc.config.reload_data.update.server".translate().append(" ".lit()).append("fc.config.reload_data.update.prompt".translate().styled { s -> s.withClickEvent(ClickEvent(ClickEvent.Action.RUN_COMMAND, "/reload")) }),
    ...
    RELOAD_RESOURCES(
        ...
        "fc.config.reload_resources.update.client".translate().append(" ".lit()).append("fc.config.reload_resources.update.client.prompt".translate().styled { s -> s.withClickEvent(ClickEvent(ClickEvent.Action.RUN_COMMAND, "/fzzy_config_reload_resources")) }),

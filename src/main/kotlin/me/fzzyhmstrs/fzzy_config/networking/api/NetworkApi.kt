...
interface NetworkApi {
     ...
     * @param writer [BiConsumer]&lt;[T],[PacketByteBuf]&gt; the consumer for writing serialized data into a buffer from a payload
     ...
     * @since 0.4.1
     */
    fun <T: FzzyPayload> registerS2C(id: Identifier, writer: BiConsumer<T, PacketByteBuf>, function: Function<PacketByteBuf, T>, handler: S2CPayloadHandler<T>)
    /**
     ...
     * @since 0.4.1
     */
    fun <T: FzzyPayload> registerC2S(id: Identifier, writer: BiConsumer<T, PacketByteBuf>, function: Function<PacketByteBuf, T>, handler: C2SPayloadHandler<T>)
}
...
interface NetworkApi {
     ...
     * @param clazz [Class]&lt;[T]&gt; class type of the registered payload
     * @param function [Function]&lt;[PacketByteBuf],[T]&gt; the function for building the payload from a given buf
     * @param handler [C2SPayloadHandler] a handler for dealing with receiving the payload. This handler will be on the server handling a payload sent from the client.
     * @author fzzyhmstrs
     * @since 0.4.1
     */
